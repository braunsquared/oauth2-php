...
class OAuth2 {
    ...
    public function grantAccessToken(array $inputData = NULL, array $authHeaders = NULL) {
        $filters = array(
            ...
            "ext" => array("flags" => FILTER_REQUIRE_ARRAY)
        );
     ...
     * @param $expires_in
     *   (optional) Specifies the access token lifetime.  If empty, configuration default will be used.
     *
     * @see http://tools.ietf.org/html/draft-ietf-oauth-v2-20#section-5
     * @ingroup oauth2_section_5
     */
    protected function createAccessToken($client_id, $user_id, $scope = NULL, $expires_in = FALSE) {
